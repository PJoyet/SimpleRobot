...
// console.log(R.DH["theta"]);
// R.simule([0.5,0.5,0]);
// console.log(R.DH["theta"].reshape([3]));
...
function drawRobot(robot,scale=1) {
    ...
    for (let index = 0; index < robot.liaison.length; index++) {
        ...
        // Coords.subset(math.index(0,index),math.add(data,origin))
        // console.log(Coords.subset(math.index([0,1],index)));
        // Coords.subset(math.index([0,1],index),math.add(Coords.subset(math.index([0,1],index)),origin));
    }
